            ...
            <div className="bg-gradient-to-r from-sky-500 to-indigo-500 h-1/3 w-1/3 m-auto text-center px-4 py-4 ">
                ...
                <div className="relative my-2">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 448 512">
                ...
                <div className="relative my-2">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 512 512">
                    ...
                    <input type="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Mật khẩu" required></input>
                </div>
                <button onClick={(e) => onHandleButton()} className="bg-white w-full border-spacing-1 rounded-3xl text-blue-600 p-2"><strong>ĐĂNG NHẬP</strong></button>
            </div>
