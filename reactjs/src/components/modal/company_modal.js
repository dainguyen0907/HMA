    ...
    return (
        <Modal show={companyFeature.openCompanyModal} >
            <Modal.Body className="relative">
                ...
                <div>
                    <FloatingLabel label="Tên công ty" variant="outlined" type="text" value={companyName} onChange={(e)=>setCompanyName(e.target.value)} autoComplete="off"/>
                ...
                <div className="pt-2 flex flex-row-reverse gap-2">
                    <Button color="blue" type="submit" onClick={onHandleSubmit}>{companyFeature.companySelection?"Cập nhật":"Thêm"}</Button>
